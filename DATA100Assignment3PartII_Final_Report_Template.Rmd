...
For combining happiness data to climate awareness and covid data, we joined this data to the data set climate_covid, which was made from joining the previous two data sets. We used inner\_join to join the columns "country" and "ladder\_score" from happiness to the climate awareness and covid data.
