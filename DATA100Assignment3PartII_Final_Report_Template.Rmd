...
We first joined climate awareness data to covid data by selecting only columns "country", "continent", and `total_cases`. Then, we used `inner\_join` to join those columns of the covid 2020 data with the climate awareness data. 
