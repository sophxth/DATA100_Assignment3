...
The first aspect that we found interesting is shown in this scatterplot.
...
```{r fig:insight3, fig.cap="Average happiness score by COVID-19 case quartile.", fig.height=4, fig.width=6}
