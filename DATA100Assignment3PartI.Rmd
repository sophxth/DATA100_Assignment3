...
ice_extent_yearly <- ice_extent_daily |>
  ...
  arrange(year, region, factor(name, levels = c("min", "max")))
...
covid_2020_match_country <- covid_2020 |>
  filter(!is.na(continent)) |>      # remove regions & aggregates
...
happiness <- read.xlsx("DataForTable2.1.xlsx") |>
    ...
    # Use arrange + distinct to get the most recent year
